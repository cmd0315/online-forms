                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-lg-4 text-right">
                            @if(e($onlineForm->receiverApproved()))
                                <span class="label label-success"> Approved</span>
                            @elseif(e($onlineForm->receiverRejected()))
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            {{Form::open(['class' => 'form-horizontal', 'route' => ['receiving.update', e($onlineForm->id)], 'method' => 'PATCH'])}}
                                <div class="row">
                                    <div class="col-lg-12">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="radio">
                                            <label>
                                                @if(e($onlineForm->receiverRejected()))
                                ...
                                <div class="row">
                                    <div class="col-lg-12 text-right">
                                        <a class="btn btn-default" href="{{ URL::route('receiving.show', e($onlineForm->id)) }}">Review Request</a>
                                        <button type="submit" class="btn btn-warning" id="submit-decision">Submit</button>
                                    </div>
                                </div><!-- .row -->
                                <input type="hidden" id="receiver" name="receiver" value="{{$currentUser->username}}">
                            {{ Form::close() }}
                        </div>
                    </div><!-- .row -->
                </div>
